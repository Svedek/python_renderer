...
class OrthoCamera:
    ...
    def project_point(self, p):
        ...
        p2[:3] = self.transform.apply_inverse_to_point(p)
    ...
    def project_inverse_point(self, p):
        ...
        return self.transform.apply_to_point(p2).flatten()

    def view_dir(self):
        return self.transform.apply_to_normal(np.array([0.0, 1.0, 0.0]))
...
class PerspectiveCamera:
    ...
    def project_inverse_point(self, p):
        ...
        return self.transform.apply_to_point(pc)
    ...
    def from_FOV(fov, near, far, ratio):
        return PerspectiveCamera(1,2,3,4,5,6)
